...
# Folders with user-specific changes — never overwritten on update > "hyprcandy" "hyprcandydock"
SKIP_DIRS=("background" "background.png" "fastfetch" "gtk-3.0" "gtk-4.0" "hypr" "qt5ct" "qt6ct")
